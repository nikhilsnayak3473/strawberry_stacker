...
def edrone1_main():
    """Main function for edrone1"""
    edrone1_rows = [[2, 4, 2], [2, 1, 2],
                    [20, 1, 2], [20, 3, 2], [30, 3, 2], [0, 5, 2], [30, 5, 2], [40, 5, 2]]
    edrone1_global_offset = -60.2
    edrone1 = MultiDrone('edrone1', edrone1_rows, edrone1_global_offset)
    edrone1.start_mission()


if __name__ == '__main__':
    # starts two threads for edrone0 and edrone1 respectively
    try:
        edrone0 = Thread(target=edrone0_main)
        edrone0.start()
        edrone1 = Thread(target=edrone1_main)
        edrone1.start()
